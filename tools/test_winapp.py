...
# -*- coding: utf-8 -*-
# =====================================================================
#  test_winapp.py - NexOS Windows 应用测试工具
# ---------------------------------------------------------------------
...
MON_SOCK   = "/tmp/NexOS_mon.sock"                # QEMU monitor (WSL)
SHOT_PATH  = "/tmp/NexOS_shot.ppm"
SERIAL_LOG = "/tmp/NexOS_serial.txt"

ALLOWED_EXT = {".exe", ".bat", ".cmd", ".ps1", ".psm1", ".psd1", ".com", ".dll"}
FS_NAME_MAX = 20                                    # NexOS SFS 文件名上限
