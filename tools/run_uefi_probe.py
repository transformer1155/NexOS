#!/usr/bin/env python3
"""Boot build/os_uefi_diag_probe.img (diagnostic freeze build) in QEMU OVMF
...
m.DISK = os.path.join(m.BUILD, "os_uefi_diag_probe.img")
m.SERIAL = os.path.join(m.BUILD, "serial_diag_probe.txt")
