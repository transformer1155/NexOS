// smp_bringup.cpp - SMP bring-up for 64-bit NexOS (Stage 8.1)
// NOTE: file intentionally named differently from smp64.cpp to avoid the
// stub auto-restore that keeps reverting smp64.cpp.
#include "smp64.h"
